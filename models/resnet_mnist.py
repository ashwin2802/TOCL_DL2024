...
class ResNet(nn.Module):
    def __init__(self, block, layers, num_classes=10):
        ...
        # Adjust input to single channel for MNIST
...
def resnet_mnist(depth, num_classes=10):
    """
    Creates a ResNet model based on the specified depth and number of classes.
...
if __name__ == "__main__":
    # Example usage of the ResNet for MNIST
    model = resnet(18, num_classes=10)  # ResNet-18 for MNIST
    print(model)

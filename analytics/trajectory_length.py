...
if __name__ == "__main__":
    # folder_path = "./results/CIFAR-100"
    folder_path = "./results/MNIST-10/task_aware_simpleMLP-784-256-3-2-5"
    key_order = [
    ...
    # Analyze forgetting measures and trajectory lengths
    results_path = "./plots/MNIST-10"
    os.makedirs(results_path, exist_ok=True)
    analyze_forgetting("variance", folder_path, results_path)